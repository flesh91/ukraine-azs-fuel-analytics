...
> **AZS Analytics** — аналітичний дашборд, що автоматизує збір даних та розраховує орієнтовну справедливу ціну пального на основі нафти Brent, валютного курсу та податкового навантаження.
>
> Проект створено, щоб розрахувати потенційно справедливу ціну бензину з урахуванням трьох ключових факторів: світової вартості нафти, курсу валют НБУ та чинних акцизів. Оскільки у публічному доступі відсутні готові сервіси, які б дозволили автоматично зіставити ці фактори з реальними роздрібними цінами на АЗС в Україні, цей інструмент був розроблений як відкрите рішення за допомогою штучного інтелекту.

...
>
> Проект створено, щоб розрахувати потенційно справедливу ціну бензину з урахуванням трьох ключових факторів: світової вартості нафти, курсу валют НБУ та чинних акцизів.
